...
```
Пояснение
есть независимый блок header. в нем лежит независимый блок search, имеющий вложеные элементы search__input и search__button. по-этому эти элементы префиксируются именем родительского блока
